...
(function (root, factory) {
  ...
  ZaloPay.getDeviceInfo = function (cb) {
    ZaloPay.call('getDeviceInfo', cb);
  };
  ...
  ZaloPay.setExistButtonVisibility = function (opt) {
    if (!isObj(opt)) {
      writeLog('error', 'ZaloPay.setExistButtonVisibility', 'Received invalid object');
      return;
    }
    if (isStr(opt.ishidden)) {
      opt = {
        ishidden: opt.ishidden
      };
      ZaloPay.call('setExistButtonVisibility', opt);
    }
  };
  /**
