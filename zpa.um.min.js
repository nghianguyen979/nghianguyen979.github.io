...
(function (root, factory) {
  ...
  /*
   * Trigger saving smart otp config from ZPA
   *
   */
  ZaloPay.saveSmartOtpConfig = function (opt, cb) {
   writeLog('info', '[Start] ZaloPay.saveSmartOtpConfig')

   ZaloPay.call('saveSmartOtpConfig', opt, cb);

   writeLog('info', '[End] ZaloPay.saveSmartOtpConfig')
  };
